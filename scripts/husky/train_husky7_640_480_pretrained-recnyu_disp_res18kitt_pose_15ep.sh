...
DISP_NET=checkpoints/r18_husky_640_480_pretrained_nyu_disp_kitti_pose/12ep/dispnet_checkpoint.pth.tar

# orig posenet is res18kitti256
POSE_NET=checkpoints/r18_husky_640_480_pretrained_nyu_disp_kitti_pose/12ep/exp_pose_checkpoint.pth.tar
