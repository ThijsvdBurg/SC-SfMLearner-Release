...
def main():
    ...
    for file in tqdm(test_files):
        ...
        if args.output_disp:
            ...
            imsave(output_dir/'{}_disp{}'.format(file_name, file_ext), cv2.resize(disp_transpose,(640,480)))
        ...
        if args.output_depth:
            ...
            imsave(output_dir/'{}_depth_max_None{}'.format(file_name, file_ext),cv2.resize( np.transpose(depth_array2, (1, 2, 0)),(640,480)))
