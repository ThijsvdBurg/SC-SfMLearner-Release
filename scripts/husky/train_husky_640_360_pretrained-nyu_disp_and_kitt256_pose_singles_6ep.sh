...
RESNET_FOLDER=checkpoints/r18_husky_640_360_pretrained_nyu_disp_and_kitt256_pose_singles/5ep
...
--log-output \
--dataset nyu \
--name r18_husky_640_360_pretrained_kitti_256_disp_and_pose_singles \
--img-width 640 \
--img-height 360 \
